...
PRESETS = {
    ...
    "warm_kodak": (0.0, (.01, .02, -.01), (1.08, 1.04, .95), (1.05, 1.02, .92), 1.05, .15, 0., (.55, .60, .40), .08, (.95, .88, .70), .12),
    ...
    "golden_hour": (.15, (.02, 0., -.03), (1.12, 1.05, .85), (1.15, 1.05, .75), 1.10, .20, 0., (.60, .30, .10), .10, (1., .85, .45), .15),
    ...
    "vintage_analog": (0.0, (.03, .02, -.01), (1.08, 1.03, .92), (1.08, 1., .85), .90, 0., .05, (.65, .50, .25), .10, (1., .90, .70), .12),
